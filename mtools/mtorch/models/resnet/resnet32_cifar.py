...
def create_model(use_fc=False,  dropout=None, stage1_weights=False, dataset=None, log_dir=None,
                 test=False, *args):
    print('Loading ResNet 32 Feature Model.')
    resnet32 = ResNet32_Cifar(BasicBlock, [5, 5, 5])
    return resnet32
...
if __name__ == '__main__':
    ...
    model = create_model(use_fc=False)
    y = model(x)
    print(y.size())
